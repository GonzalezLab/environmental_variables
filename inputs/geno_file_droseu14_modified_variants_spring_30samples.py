...
geno_file = []
columns = [18,21,23,25,29,31,32,33,36,37,41,42,44,47] # Selction only of populations we are going to use for spring
...
flag = 0
geno_output = open("/Users/pogo/Documents/Maria/Baypass/DrosEU/only_variants/spring/Droseu14_spring30_exmulti.geno", 'w')
for line in vcf:
    geno_file_line = []
