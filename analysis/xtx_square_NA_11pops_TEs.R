...
num_sig_NA_auto = length(xtx.pi.NA.MAF$V1)*0.01 # Changed for TEs
significant.xtx.pi.NA.MAF = tail(xtx.pi.NA.MAF[order(xtx.pi.NA.MAF$xtxstar),], 20507L)
write.table(significant.xtx.pi.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/NA/analysis/core/xtx/TEs/TEs_auto.NA.xtx.MAF.significant_1percent.txt", sep = "\t", row.names= F, quote=F)
...
num_sig_NA_X = length(xtx.pi.NA.Xchrom.MAF$MRK)*0.025
significant.xtx.pi.NA.X.MAF = tail(xtx.pi.NA.Xchrom.MAF[order(xtx.pi.NA.Xchrom.MAF$xtxstar),], 6963L)
write.table(significant.xtx.pi.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/NA/analysis/core/xtx/TEs/TEs_NA.Xchrom.xtx.MAF.significant0.005.txt", sep = "\t", row.names= F, quote=F)

significant.xtx.pi.NA.X.MAF = tail(xtx.pi.NA.Xchrom.MAF[order(xtx.pi.NA.Xchrom.MAF$xtxstar),], 2785L)
write.table(significant.xtx.pi.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/NA/analysis/core/xtx/TEs/TEs_NA.Xchrom.xtx.MAF.significant_1percent.txt", sep = "\t", row.names= F, quote=F)
