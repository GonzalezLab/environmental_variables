...
significant.TE.all30.xtx.MAF=tail(all30.xtx.MAF[order(all30.xtx.MAF$V11),], 33250L)
write.table(significant.TE.all30.xtx.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/TE_thresholds_top_0.1/all30_autosomes_xtx_TEs_top_2.5%.txt", sep = "\t", row.names= F, quote=F)

# P-value histograms:
png("/Users/pogo/Documents/Maria/Baypass/paper/figures/all30.auto.plots.png")
par(mfrow=c(2,2))
hist(pvalues.bilateral, breaks=100, freq=F, main="p-values without MAF filtering")
abline(h=1, col="red")
hist(pvalues.bilateral.MAF, breaks=100, freq=F, main="p-values with MAF filtering")
abline(h=1, col="red")
plot(all30.xtx$V6, all30.xtx$V11)
plot(all30.xtx.MAF$V6, all30.xtx.MAF$V11)
dev.off()

#png("/Users/pogo/Documents/Maria/Baypass/DrosEU/analysis/all30/new/XtX/xtx_star/star.vs.original_new.png")
#plot(original.xtx$V6,xtx.star$x)
#dev.off()
...
write.table(significant.TE.all30.xtx.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/TE_thresholds_top_0.1/all30_Xchr_xtx_TEs_top2.5%.txt", sep = "\t", row.names= F, quote=F)


# P-value histograms:
png("/Users/pogo/Documents/Maria/Baypass/paper/figures/all30.X.plots.png")
par(mfrow=c(2,2))
hist(pvalues.bilateral.all30.X, breaks=100, freq=F, main="p-values without MAF filtering")
abline(h=1, col="red")
hist(pvalues.bilateral.all30.X.MAF, breaks=100, freq=F, main="p-values with MAF filtering")
abline(h=1, col="red")
plot(all30.xtx.X$M_XtX, all30.xtx.X$star)
plot(all30.xtx.X.MAF$M_XtX, all30.xtx.X.MAF$star)
dev.off()
...
# Write a table with all data:
write.table(significant.fall30.xtx.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/fall30_auto_xtx_complete_table.txt", sep = "\t", row.names= F, quote=F)
# Write the bedfile:
...
write.table(significant.TE.fall30.xtx.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/TE_thresholds_top_0.1/fall30_auto_TE_top2.5%.txt", sep = "\t", row.names= F, quote=F)

#plot(fall30.original.xtx.MAF$V6, fall30.xtx.star.MAF$x)
# P-value histograms:
png("/Users/pogo/Documents/Maria/Baypass/paper/figures/fall30.auto.plots.png")
par(mfrow=c(2,2))
hist(pvalues.bilateral.fall, breaks=100, freq=F, main="p-values without MAF filtering")
abline(h=1, col="red")
hist(pvalues.bilateral.fall.MAF, breaks=100, freq=F, main="p-values with MAF filtering")
abline(h=1, col="red")
plot(fall30.original.xtx$V6, fall30.original.xtx$star)
plot(fall30.original.xtx.MAF$V6, fall30.original.xtx.MAF$star)
dev.off()
...
write.table(significant.TE.fall30.xtx.X, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/TE_thresholds_top_0.1/fall30_Xchrom_TE_top2.5%.txt", sep = "\t", row.names= F, quote=F)


#plot(significant.fall30.X$M_XtX, significant.fall30.X$star)
# P-value histograms:
png("/Users/pogo/Documents/Maria/Baypass/paper/figures/fall30.X.plots.png")
par(mfrow=c(2,2))
hist(pvalues.bilateral.fall.X, breaks=100, freq=F, main="p-values without MAF filtering")
abline(h=1, col="red")
hist(pvalues.bilateral.fall.X.MAF, breaks=100, freq=F, main="p-values with MAF filtering")
abline(h=1, col="red")
plot(fall30.original.xtx.X$M_XtX, fall30.original.xtx.X$star)
plot(fall30.original.xtx.X.MAF$M_XtX, fall30.original.xtx.X.MAF$star)
dev.off()


####### BERGLAND AUTOSOMES ####### 
original.xtx.NA = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/analysis/XtX/star.xtx/berglandcoreAUTO_summary_pi_xtx.out", h=T)
NA.names = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/definitive_files_2019/bergland_auto_nofix_SNPs_names.txt")
original.xtx.NA$CHR = NA.names$V1
original.xtx.NA$POS = NA.names$V2
star.xtx.NA = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/analysis/XtX/star.xtx/xtx.star.bergland.txt", h=T)
#plot(original.xtx.NA$M_XtX, star.xtx.NA$x)
# Get MAF
MAF.NA = (0.5 - abs(0.5 -original.xtx.NA$M_P))
star.xtx.NA$MAF = MAF.NA
star.xtx.NA.MAF = star.xtx.NA[star.xtx.NA$MAF>=0.01,]

## Removing inversions: THIS IS ISOLATED FROM THE REST OF RESULTS (24-01-20):


# Get p-values
pvalues.bilateral.NA=1-(2*(abs(pchisq(star.xtx.NA$x, df=6)-0.5)))
pvalues.bilateral.NA.MAF=1-(2*(abs(pchisq(star.xtx.NA.MAF$x, df=6)-0.5)))
# Get q-values
qvalues.NA = qvalue(pvalues.bilateral.NA)
NA.MAF.qvalues = qvalue(pvalues.bilateral.NA.MAF)
summary(NA.MAF.qvalues)
# Get final matrix
original.xtx.NA$MAF = MAF.NA
original.xtx.NA$star = star.xtx.NA$x
original.xtx.NA.MAF = original.xtx.NA[original.xtx.NA$MAF>=0.01,]
write.table(original.xtx.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_auto_MAF.txt", sep = "\t", row.names= F, quote=F)
original.xtx.NA.MAF$qvalues = NA.MAF.qvalues$qvalues
significant.NA.xtx = original.xtx.NA.MAF[original.xtx.NA.MAF$qvalues<=0.05,]
# Threshold: 14.900167
def.NA.MAF=significant.NA.xtx[significant.NA.xtx$M_XtX>=14.9,]
# Write a table with all data:
write.table(def.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_auto_xtx_complete_table.txt", sep = "\t", row.names= F, quote=F)
# Write the bedfile:
bedfile.NA.MAF = def.NA.MAF[,c(8,9,9,6,11,12)]
write.table(bedfile.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_auto_xtx_star.bed", sep = "\t", row.names= F, quote=F)


# P-value histograms:
png("/Users/pogo/Documents/Maria/Baypass/paper/figures/NA.auto.plots.png")
par(mfrow=c(2,2))
...
abline(h=1, col="red")
plot(original.xtx.NA$M_XtX, original.xtx.NA$star)
plot(original.xtx.NA.MAF$M_XtX, original.xtx.NA.MAF$star)
dev.off()


####### BERGLAND X CHROM #######
original.xtx.NA.X = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/analysis/XtX/star.xtx/berglandcoreXsize_summary_pi_xtx.out", h=T)
NA.X.names = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/definitive_files_2019/bergland_X_nofix_SNPs_names.txt")
original.xtx.NA.X$CHR = NA.X.names$V1
original.xtx.NA.X$POS = NA.X.names$V2
star.xtx.NA.X = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/analysis/XtX/star.xtx/bergland.xtx.star.X.txt", h=T)
plot(original.xtx.NA.X$M_XtX, star.xtx.NA.X$x)
# Get MAF values
MAF.NA.X = (0.5 - abs(0.5 -original.xtx.NA.X$M_P))
star.xtx.NA.X$MAF = MAF.NA.X
star.xtx.NA.X.MAF = star.xtx.NA.X[star.xtx.NA.X$MAF>=0.01,]
# Get p-values
pvalues.bilateral.NA.X=1-(2*(abs(pchisq(star.xtx.NA.X$x, df=6)-0.5)))
pvalues.bilateral.NA.X.MAF=1-(2*(abs(pchisq(star.xtx.NA.X.MAF$x, df=6)-0.5)))
# Get q-values
qvalues.NA.X=qvalue(pvalues.bilateral.NA.X.MAF)
summary(qvalues.NA.X)
# Final matrix
original.xtx.NA.X$MAF = MAF.NA.X
original.xtx.NA.X$star = star.xtx.NA.X$x
original.xtx.NA.X.MAF = original.xtx.NA.X[original.xtx.NA.X$MAF>=0.01,]
write.table(original.xtx.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_Xchr_MAF.txt", sep = "\t", row.names= F, quote=F)
original.xtx.NA.X.MAF$qvalues = qvalues.NA.X$qvalues
significant.NA.X.MAF = original.xtx.NA.X.MAF[original.xtx.NA.X.MAF$qvalues<=0.05,]
# Threshold: 12.084377
def.NA.X.MAF=significant.NA.X.MAF[significant.NA.X.MAF$M_XtX>=12.08,]
# Write a table with all data:
write.table(def.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_Xchr_xtx_complete_table.txt", sep = "\t", row.names= F, quote=F)
# Write the bedfile:
bedfile.NA.X.MAF = def.NA.X.MAF[,c(8,9,9,6,12)]
write.table(bedfile.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_Xchr_xtx.bed", sep = "\t", row.names= F, quote=F)

# P-value histograms:
png("/Users/pogo/Documents/Maria/Baypass/paper/figures/NA.X.plots.png")
par(mfrow=c(2,2))
...
abline(h=1, col="red")
plot(original.xtx.NA.X$M_XtX, original.xtx.NA.X$star)
plot(original.xtx.NA.X.MAF$M_XtX, original.xtx.NA.X.MAF$star)
dev.off()



####### BERGLAND AUTOSOMES WITH CORRECTED TEs ####### 
original.xtx.NA = read.table("/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/corrected_TE_order/berglandcoreAUTOcorrected_summary_pi_xtx.out", h=T)
NA.names = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/definitive_files_2019/ann_v5/geno_files/auto_bergland_v5_names_corrected.txt")
original.xtx.NA$CHR = NA.names$V1
original.xtx.NA$POS = NA.names$V2
star.xtx.NA = read.table("/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/corrected_TE_order/berglandcoreAUTOcorrected_xtx_star.txt", h=T)
#plot(original.xtx.NA$M_XtX, star.xtx.NA$x)
# Get MAF
MAF.NA = (0.5 - abs(0.5 -original.xtx.NA$M_P))
star.xtx.NA$MAF = MAF.NA
...
original.xtx.NA$star = star.xtx.NA$x
original.xtx.NA.MAF = original.xtx.NA[original.xtx.NA$MAF>=0.01,]
#write.table(original.xtx.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_auto_MAF_corrected_TEs.txt", sep = "\t", row.names= F, quote=F)
original.xtx.NA.MAF$qvalues = NA.MAF.qvalues$qvalues
write.table(original.xtx.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/NA_auto_MAF_ALL_corrected_TEs.txt", sep = "\t", row.names= F, quote=F)
significant.NA.xtx = original.xtx.NA.MAF[original.xtx.NA.MAF$qvalues<=0.05,]
# Threshold: 14.900167
#def.NA.MAF=significant.NA.xtx[significant.NA.xtx$M_XtX>=14.9,]
def.NA.MAF=significant.NA.xtx[significant.NA.xtx$star>=31.18,]
# Write a table with all data:
write.table(def.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/NA_auto_xtx_complete_table_corrected_TEs_2.txt", sep = "\t", row.names= F, quote=F)
# Write the bedfile:
bedfile.NA.MAF = def.NA.MAF[,c(8,9,9,6,11,12)]
write.table(bedfile.NA.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_auto_xtx_star.bed", sep = "\t", row.names= F, quote=F)
...
####### BERGLAND X CHROM WITH CORRECTED TEs #######
original.xtx.NA.X = read.table("/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/corrected_TE_order/berglandcoreXsize_summary_pi_xtx.out", h=T)
NA.X.names = read.table("/Users/pogo/Documents/Maria/Baypass/Bergland/definitive_files_2019/ann_v5/geno_files/X_bergland_v5_names.txt")
original.xtx.NA.X$CHR = NA.X.names$V1
original.xtx.NA.X$POS = NA.X.names$V2
star.xtx.NA.X = read.table("/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/corrected_TE_order/berglandX_correctedTEs_xtx_star.txt", h=T)
#plot(original.xtx.NA.X$M_XtX, star.xtx.NA.X$x)
# Get MAF values
MAF.NA.X = (0.5 - abs(0.5 -original.xtx.NA.X$M_P))
star.xtx.NA.X$MAF = MAF.NA.X
...
#write.table(original.xtx.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_Xchr_MAF.txt", sep = "\t", row.names= F, quote=F)
original.xtx.NA.X.MAF$qvalues = qvalues.NA.X$qvalues
#write.table(original.xtx.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/corrected_TE_order/NA_Xchr_MAF_ALL_corrected_TE.txt", sep = "\t", row.names= F, quote=F)
significant.NA.X.MAF = original.xtx.NA.X.MAF[original.xtx.NA.X.MAF$qvalues<=0.05,]
#write.table(significant.NA.xtx, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA_auto_xtx_complete_table_corrected_TEs.txt", sep = "\t", row.names= F, quote=F)
# Threshold: 12.084377 (star: 32.15267868)
def.NA.X.MAF=significant.NA.X.MAF[significant.NA.X.MAF$star>=32.15,]
# Write a table with all data:
write.table(def.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/NA_Xchr_xtx_complete_table_corrected_TEs.txt", sep = "\t", row.names= F, quote=F)
# Write the bedfile:
bedfile.NA.X.MAF = def.NA.X.MAF[,c(8,9,9,6,12)]
write.table(bedfile.NA.X.MAF, "/Users/pogo/Documents/Maria/Baypass/analysis/reanalysis_december_2019/NA/NA_Xchr_xtx_corrected_TEs.bed", sep = "\t", row.names= F, quote=F)
